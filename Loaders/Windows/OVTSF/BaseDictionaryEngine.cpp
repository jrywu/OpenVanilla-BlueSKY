...
VOID CBaseDictionaryEngine::SortListItemByFindKeyCode(_Inout_ COVTSFArray<CCandidateListItem> *pItemList)
{
...
VOID CBaseDictionaryEngine::MergeSortByFindKeyCode(_Inout_ COVTSFArray<CCandidateListItem> *pItemList, int leftRange, int rightRange)
{
    ...
    if (candidateCount > 2)
    {
        ...
        COVTSFArray<CCandidateListItem> ListItemTemp;
