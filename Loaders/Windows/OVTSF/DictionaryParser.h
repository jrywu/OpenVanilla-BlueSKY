...
public:
    ...
    BOOL ParseLine(_In_reads_(dwBufLen) LPCWSTR pwszBuffer, DWORD_PTR dwBufLen, _Out_ CParserStringRange *psrgKeyword, _Inout_opt_ COVTSFArray<CParserStringRange> *pValue = nullptr);
