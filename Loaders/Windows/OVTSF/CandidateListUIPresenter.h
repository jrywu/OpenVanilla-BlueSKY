...
{
public:
    CCandidateListUIPresenter(_In_ COVTSF *pTextService, ATOM atom,
    ...
    void _SetText(_In_ COVTSFArray<CCandidateListItem> *pCandidateList, BOOL isAddFindKeyCode);
    void _ClearList();
    ...
    void RemoveSpecificCandidateFromList(_In_ LCID Locale, _Inout_ COVTSFArray<CCandidateListItem> &candidateList, _In_ CStringRange &srgCandidateString);
...
private:
    ...
    void AddCandidateToCandidateListUI(_In_ COVTSFArray<CCandidateListItem> *pCandidateList, BOOL isAddFindKeyCode);

    void SetPageIndexWithScrollInfo(_In_ COVTSFArray<CCandidateListItem> *pCandidateList);
