...
CKeyStateCategory* CKeyStateCategoryFactory::MakeKeyStateCategory(KEYSTROKE_CATEGORY keyCategory, _In_ COVTSF *pTextService)
{
...
*/
CKeyStateCategory::CKeyStateCategory(_In_ COVTSF *pTextService)
{
...
*/
CKeyStateComposing::CKeyStateComposing(_In_ COVTSF *pTextService) : CKeyStateCategory(pTextService)
{
}
...
*/
CKeyStateCandidate::CKeyStateCandidate(_In_ COVTSF *pTextService) : CKeyStateCategory(pTextService)
{
}
...
CKeyStatePhrase::CKeyStatePhrase(_In_ COVTSF *pTextService) : CKeyStateCategory(pTextService)
{
}
