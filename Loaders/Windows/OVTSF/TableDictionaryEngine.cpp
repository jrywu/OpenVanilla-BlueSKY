...
VOID CTableDictionaryEngine::CollectWord(_In_ CStringRange *pKeyCode, _Inout_ COVTSFArray<CStringRange> *pWordStrings)
{
...
VOID CTableDictionaryEngine::CollectWord(_In_ CStringRange *pKeyCode, _Inout_ COVTSFArray<CCandidateListItem> *pItemList)
{
    CDictionaryResult* pdret = nullptr;
    CDictionarySearch dshSearch(_locale, _pDictionaryFile, pKeyCode);
...
VOID CTableDictionaryEngine::CollectWordForWildcard(_In_ CStringRange *pKeyCode, _Inout_ COVTSFArray<CCandidateListItem> *pItemList)
{
    CDictionaryResult* pdret = nullptr;
    CDictionarySearch dshSearch(_locale, _pDictionaryFile, pKeyCode);
...
VOID CTableDictionaryEngine::CollectWordFromConvertedStringForWildcard(_In_ CStringRange *pString, _Inout_ COVTSFArray<CCandidateListItem> *pItemList)
{
    CDictionaryResult* pdret = nullptr;
