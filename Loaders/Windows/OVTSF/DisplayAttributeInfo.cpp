...
// The descriptions
const WCHAR CDisplayAttributeInfoInput::_s_szDescription[] = L"OVTSF Text Service Display Attribute Input";
const WCHAR CDisplayAttributeInfoConverted::_s_szDescription[] = L"OVTSF Text Service Display Attribute Converted";
