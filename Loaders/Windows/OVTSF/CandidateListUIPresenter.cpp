...
//////////////////////////////////////////////////////////////////////
//
// COVTSF candidate key handler methods
//
//////////////////////////////////////////////////////////////////////
...
HRESULT COVTSF::_HandleCandidateFinalize(TfEditCookie ec, _In_ ITfContext *pContext)
{
    HRESULT hr = S_OK;
...
HRESULT COVTSF::_HandleCandidateConvert(TfEditCookie ec, _In_ ITfContext *pContext)
{
...
HRESULT COVTSF::_HandleCandidateWorker(TfEditCookie ec, _In_ ITfContext *pContext)
{
    ...
    BSTR pbstr = nullptr;
    CStringRange candidateString;
    COVTSFArray<CCandidateListItem> candidatePhraseList;
...
HRESULT COVTSF::_HandleCandidateArrowKey(TfEditCookie ec, _In_ ITfContext *pContext, _In_ KEYSTROKE_FUNCTION keyFunction)
{
    ec;
    pContext;
...
HRESULT COVTSF::_HandleCandidateSelectByNumber(TfEditCookie ec, _In_ ITfContext *pContext, _In_ UINT uCode)
{
...
HRESULT COVTSF::_HandlePhraseFinalize(TfEditCookie ec, _In_ ITfContext *pContext)
{
    HRESULT hr = S_OK;
...
HRESULT COVTSF::_HandlePhraseArrowKey(TfEditCookie ec, _In_ ITfContext *pContext, _In_ KEYSTROKE_FUNCTION keyFunction)
{
    ec;
    pContext;
...
HRESULT COVTSF::_HandlePhraseSelectByNumber(TfEditCookie ec, _In_ ITfContext *pContext, _In_ UINT uCode)
{
    int iSelectAsNumber = _pCompositionProcessorEngine->GetCandidateListIndexRange()->GetIndex(uCode);
    if (iSelectAsNumber == -1)
    {
...
CCandidateListUIPresenter::CCandidateListUIPresenter(_In_ COVTSF *pTextService, ATOM atom, KEYSTROKE_CATEGORY Category, _In_ CCandidateRange *pIndexRange, BOOL hideWindow) : CTfTextLayoutSink(pTextService)
{
    _atom = atom;
...
{
    *pguid = Global::OVTSFGuidCandUIElement;
    return S_OK;
}
...
void CCandidateListUIPresenter::_SetText(_In_ COVTSFArray<CCandidateListItem> *pCandidateList, BOOL isAddFindKeyCode)
{
...
void CCandidateListUIPresenter::AddCandidateToCandidateListUI(_In_ COVTSFArray<CCandidateListItem> *pCandidateList, BOOL isAddFindKeyCode)
{
...
void CCandidateListUIPresenter::SetPageIndexWithScrollInfo(_In_ COVTSFArray<CCandidateListItem> *pCandidateList)
{
...
void CCandidateListUIPresenter::RemoveSpecificCandidateFromList(_In_ LCID Locale, _Inout_ COVTSFArray<CCandidateListItem> &candidateList, _In_ CStringRange &candidateString)
{
