...
public:
    ...
    CKeyStateCategory* MakeKeyStateCategory(KEYSTROKE_CATEGORY keyCategory, _In_ COVTSF *pTextService);
    void Release();
...
{
public:
    CKeyStateCategory(_In_ COVTSF *pTextService);
...
{
public:
    CKeyStateComposing(_In_ COVTSF *pTextService);
...
{
public:
    CKeyStateCandidate(_In_ COVTSF *pTextService);
...
{
public:
    CKeyStatePhrase(_In_ COVTSF *pTextService);
...
{
public:
    CKeyStateNull(_In_ COVTSF *pTextService) : CKeyStateCategory(pTextService) {};
